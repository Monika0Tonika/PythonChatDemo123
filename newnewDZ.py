...
elephant_computer= ImageTk.PhotoImage(Image.open("Elephant_computer.png"))
mouse_computer= ImageTk.PhotoImage(Image.open("Mouse_computer.png"))
cat_computer= ImageTk.PhotoImage(Image.open("Cat_computer.png"))
...
def outcome(user_choice):
    ...
    outcome_image={
        "elephant": elephant_computer, 
        "mouse": mouse_computer,
        "cat": cat_computer
    }
    computer_choice = random.choice(outcomes)
    label_computer_image.config(image=outcome_image[computer_choice])
    label_computer_image.image = outcome_image[computer_choice]
...
label_computer_image.place(x=220, y=320)
